...
// is_local(15), cpid(16), adapter_name(17), netns(18), sacked_out(19)
func (t *TcpConnStats) Output() string {
	return fmt.Sprintf("%d, %s, %d, %s, %d,	%s, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %s, %d, %d\n",
		...
		t.Direction, t.ConnState.Pid, "ebpf", t.Netns, t.SackedOut)
}

func (t *TcpConnStats) String() string {
	return fmt.Sprintf("%s (#%d): %s, %d, %d, rtt=%d, %d, retransmit=%d, sackedOut=%d", t.Time(), t.ConnState.Pid, t.Addr(),
		t.ConnState.RecvBytes, t.ConnState.SentBytes, t.Rtt, t.RttVar, t.Retransmit, t.SackedOut)
}
