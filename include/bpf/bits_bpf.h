...
{
	/* Everything non-zero or non-const (currently unsupported) as c gets handled here. */
...
static __always_inline __maybe_unused __nobuiltin("memset") void bpf_memset(void *d, int c, __u64 len)
{
...
static __always_inline __maybe_unused __nobuiltin("memcpy") void bpf_memcpy(void *d, const void *s, __u64 len)
{
...
__bpf_no_builtin_memcmp(const void *x __maybe_unused, const void *y __maybe_unused, __u64 len __maybe_unused)
{
	__throw_build_bug();
	return 0;
}
 ...
 */
static __always_inline __maybe_unused __nobuiltin("memcmp") __u64 bpf_memcmp(const void *x, const void *y, __u64 len)
{
...
static __always_inline __maybe_unused void*
__bpf_no_builtin_memmove(void *d __maybe_unused, const void *s __maybe_unused, __u64 len __maybe_unused)
{
	__throw_build_bug();
}
...
static __always_inline __maybe_unused __nobuiltin("memmove") void bpf_memmove(void *d, const void *s, __u64 len)
{
